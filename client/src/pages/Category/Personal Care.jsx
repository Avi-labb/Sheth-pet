              ...
              <div className="sticky top-24 h-fit bg-white lg:bg-transparent border lg:border-0 border-[#DEDDD6] p-4 lg:p-0 space-y-6">
                <div className="space-y-3">
                  <div className="flex items-center gap-2 pb-2 border-b border-[#DEDDD6]">
                    ...
                    <span className="text-[12px] font-mono uppercase tracking-wider text-slate-800">
                      Filters
                    </span>
                  </div>
                      ...
                      >
                        <div className="flex-1 flex flex-col" style={{ pointerEvents: 'none' }}>
                          ...
                          <div className="p-4 flex-1 flex flex-col justify-between gap-3">
                            <div className="space-y-1">
                              {product.sku && (
                                <span className="block font-medium text-[10px] text-slate-600">
                                  SKU · {product.sku}
                                </span>
                              )}
                              <h3
                                  ...
                                  {colors.map((color, idx) => {
                                    ...
                                    return (
                                      <button
                                        ...
                                        className={`px-3 py-2 text-xs sm:px-2 sm:py-1 sm:text-[10px] font-medium uppercase tracking-wide border transition-all ${
                                          isSelected
                        ...
                        >
                          ...
                          >
                            ...
                            <ArrowUpRight
                              size={13}
                              className="text-slate-800 transition-transform group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5"
                            />
                          </Link>
