...
const Pharmaceutical = () => {
 ...
 setLoading(true)
 try {
 const result = await productAPI.getProducts(null, 'Pharmaceutical')
 if (result.ok) {
 ...
 <div className="flex items-center gap-2 text-[11px] mt-5 sm:mt-20 sm:mb-42 sm:text-[15px] font-mono uppercase tracking-[0.2em] text-white mb-6">
 <Link to="/" className="hover:text-red-600 transition-colors">Home</Link>
 <span>/</span>
 <span className="text-white font-bold">Pharmaceutical</span>
 </div>
 ...
 >
 Pharmaceutical <span className="text-red-600">Packaging.</span>
 </h1>
 <p className="text-sm sm:text-lg text-white font-medium leading-relaxed max-w-2xl">
 Compliant containment systems engineered for absolute product integrity. From primary contact materials to tamper-evident closures, built strictly to global pharmacopeial standards.
 </p>
 </div>
 </div>
 </section>
