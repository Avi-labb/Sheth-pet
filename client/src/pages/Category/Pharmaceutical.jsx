...
import pharmaImage from '../../assets/images/Pharmaceutical.jpg'
...
const Pharmaceutical = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true)
    try {
      console.log('Fetching products for Pharmaceutical page...')
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 relative z-10">
          ...
          <p className="text-lg text-slate-300 max-w-3xl leading-relaxed mb-8">
            High-quality, compliant packaging solutions for pharmaceutical products. Our containers meet strict regulatory standards for safety, durability, and product protection.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-red-500"></div>
                <span className="text-sm font-medium">Child Resistant</span>
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 border border-white/20">
              <div className="flex items-center gap-2">
