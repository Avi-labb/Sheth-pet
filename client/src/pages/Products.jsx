  ...
  return (
    ...
    >
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start lg:h-[calc(100vh-4rem)]">
          {/* ── LEFT SIDEBAR: Sticky ── */}
          <aside
            className="lg:col-span-3 lg:sticky lg:top-20 self-start -mx-4 px-4 sm:mx-0 sm:px-0"
          ...
          <main className="lg:col-span-9 lg:h-[calc(100vh-5rem)] lg:overflow-y-auto no-scrollbar">            {loading ? (
