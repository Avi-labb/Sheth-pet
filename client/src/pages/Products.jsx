...
const Products = () => {
 ...
 return (
 <div
 className="min-h-screen bg-[#FAFAF8] text-[#15171A] pt-16 selection:bg-[#D4530F] selection:text-white"
 ...
 <div
 className="sticky top-24 h-fit bg-white lg:bg-transparent border lg:border-0 border-[#DEDDD6] p-4 lg:p-0 space-y-6"
 >
 ...
 : 'bg-transparent text-slate-800 border-[#DEDDD6] lg:border-transparent hover:text-[#15171A] hover:bg-[#DEDDD6]/30'
 }`}
 >
 <span>{category}</span>
 <ChevronRight
 size={12}
 className={`hidden lg:block transition-transform ${isActive ? 'translate-x-0 text-white' : '-translate-x-1 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 text-[#8C8E8A]'
 }`}
 />
 </button>
 )
 ...
 <div key={index} className="bg-white aspect-[4/5] p-6 space-y-6 animate-pulse">
 ...
 {currentMoq && (
 <div className="flex items-center justify-between border border-slate-300 px-3 py-2 bg-white">
