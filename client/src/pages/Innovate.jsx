            ...
            {customizationItems.map((item, index) => {
              return (
                ...
                >
                  ...
                  <div className="mb-5 w-20 h-20 sm:w-24 sm:h-24  rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center group-hover:bg-gradient-to-br group-hover:from-red-600 group-hover:to-amber-500 transition-all duration-300 shadow-inner overflow-hidden">
                    <img
                      src={item.image}
                      alt={item.name}
