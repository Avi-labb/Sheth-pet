...
const categoryData = {
 ...
 <NewProductPopup />
 <section className="relative min-h-screen flex flex-col justify-between lg:justify-end overflow-hidden bg-white">
 ...
 <section className="py-16 md:py-24 bg-gradient-to-b from-[#FAF9F6] to-white border-y border-neutral-200/60">
 ...
 <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center bg-white rounded-3xl p-6 md:p-12 lg:p-14 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-neutral-100">
 ...
 <p className="text-[16px] md:text-[17px] leading-relaxed text-neutral-700">
 Established in <strong className="text-neutral-900 font-semibold">1996</strong>, 
 Sheth PET And Polymers Private Limited manufactures, sells, and exports world-class{' '}
 <span className="text-neutral-900 font-medium border-b-2 border-[#A8312A]/10">
 ...
 <div className="text-xs font-bold uppercase tracking-wider text-neutral-700 leading-snug">
 Years of Engineering<br />Excellence
 </div>
 </div>

 {/* Footprint Indicator */}
 <div className="flex items-start gap-3 bg-neutral-50 p-3.5 rounded-xl border border-neutral-100">
 <MapPin className="w-5 h-5 text-[#A8312A] shrink-0 mt-0.5" />
 <div className="text-xs leading-normal text-neutral-700">
 <span className="font-bold text-neutral-800 block mb-0.5">Strategic Footprint</span>
 ...
 <div className="relative group w-full max-w-[440px] aspect-[4/3] sm:aspect-square lg:aspect-[11/12] rounded-2xl overflow-hidden bg-neutral-50 border border-neutral-100 shadow-[0_12px_40px_rgba(0,0,0,0.03)] transition-all duration-300 group-hover:shadow-[0_20px_50px_rgba(168,49,42,0.05)]">
 
 {/* Main Geographic Image Element */}
 <img
 src={MapImage} 
 alt="Sheth PET Regional Manufacturing & Facilities Footprint Map"
 className="w-full h-full object-cover rounded-xl select-none mix-blend-multiply object-center transition-transform duration-700 group-hover:scale-[1.02]"
 draggable={false}
 />

 {/* Floating Map Label Badge */}
 <div className="absolute bottom-3 sm:bottom-6 left-6 z-20 bg-white/90 backdrop-blur-md px-3.5 py-2 rounded-lg shadow-md border border-neutral-200/50 flex items-center gap-2">
 <div className="w-2 h-2 rounded-full bg-[#A8312A] animate-ping" />
 <span className="text-[8px] sm:text-[11px] font-bold tracking-wider text-neutral-800 uppercase">
...
<section className="relative min-h-[500px] md:min-h-[600px] flex flex-col items-center justify-center bg-white/10 overflow-hidden py-8 md:py-12 px-4">
 ...
 <h2 
 className="text-2xl md:text-4xl font-bold text-[#15171A] tracking-tight" 
 style={{ fontFamily: "'Space Grotesk', sans-serif" }}
 >
 Serving Diverse Sectors
 </h2>
 <p className="text-xs md:text-sm text-[#5C6066] max-w-xl mx-auto leading-relaxed">
